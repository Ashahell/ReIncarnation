...
if [ "${1:-}" = sections ]; then
  ...
  OBJS3=""
  for f in app/sectproof.c gui/widgets/rsection.mcc.c gui/ctlreg.c gui/panelgeo.c gui/sect303.c gui/sect808.c gui/sect909.c gui/sectmix.c gui/sectfx.c gui/sectpat.c gui/secttr.c gui/sectui.c gui/keymap.c gui/panelui.c gui/knob_logic.c engine/dsp/kernels.c engine/seq/pattern.c engine/fx/route.c engine/seq/transport.c; do
