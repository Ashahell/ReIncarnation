...
if [ "${1:-}" = sections ]; then
  ...
  OBJS3=""
  for f in app/sectproof.c gui/widgets/rsection.mcc.c gui/ctlreg.c gui/panelgeo.c gui/sect303.c gui/sect808.c gui/sectui.c gui/knob_logic.c engine/dsp/kernels.c engine/seq/pattern.c; do
