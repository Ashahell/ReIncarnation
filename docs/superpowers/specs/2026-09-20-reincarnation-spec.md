...
| P-21 | Render task priority / device buffer floor | task pri 10 (above GUI, below input.device); device buffer floor 128 clean, 64 marginal (1–2 xruns/~10k bufs); default 256, owner-approved by ear 2026-09-26 | OPEN-09 | Dell E6320 2026-09-26: 0 xruns @1024/512/256/128 scripted takes, 5-min soak 59038 bufs 0 xruns @256; evidence docs/evidence/audio/live-render-task.md |
