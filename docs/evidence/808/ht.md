# HT — 808 high tom (measured E0 candidate, Task 8 gate G8)
...
|-----------|-------|----------|
| Sweep | 155 → ~100 Hz (end = 0.65 × start) | P-09 HT 155→100 |
| τ_pitch | 30 ms (E0) | executor choice, same family LT/MT |
...
Tail-only diff. Voice deactivates on its own past −100 dBFS (t35).
